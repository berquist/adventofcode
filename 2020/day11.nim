...
proc makePass(grid: seq[string], minFlipState: int, beam: bool = false): seq[string] =
  ...
  for i in 0 ..< nrows:
    for j in 0 ..< ncols:
      ...
      for direction in directions:
        let newPoint = (i + direction[0], j + direction[1])
...
proc iteratePoints(start: seq[string], minFlipState: int, beam: bool = false): seq[string] =
  var
    prev = start
...
L.LLLLL.LL"""
  test "part 1":
    let pass1 = init.splitlines.makePass(4).join("\n")
    check: pass1 == """
#.##.##.##
#######.##
#.#.#..#..
...
#.######.#
#.#####.##"""
    let pass2 = pass1.splitlines.makePass(4).join("\n")
    check: pass2 == """
#.LL.L#.##
#LLLLLL.L#
L.L.L..L..
...
#.LLLLLL.L
#.#LLLL.##"""
    let pass3 = pass2.splitlines.makePass(4).join("\n")
    check: pass3 == """
#.##.L#.##
#L###LL.L#
L.#.#..#..
...
#.LL###L.L
#.#L###.##"""
    let pass4 = pass3.splitlines.makePass(4).join("\n")
    check: pass4 == """
#.#L.L#.##
#LLL#LL.L#
L.L.L..#..
...
#.LLLLLL.L
#.#L#L#.##"""
    let pass5 = pass4.splitlines.makePass(4).join("\n")
    check: pass5 == """
#.#L.L#.##
#LLL#LL.L#
L.#.L..#..
...
#.LLLLLL.L
#.#L#L#.##"""
    let pass6 = pass5.splitlines.makePass(4).join("\n")
    check: pass6 == """
#.#L.L#.##
#LLL#LL.L#
L.#.L..#..
...
#.LLLLLL.L
#.#L#L#.##"""
    let selfConsistent = init.splitlines.iteratePoints(4)
...
when isMainModule:
  ...
  echo "part 1: ", input.iteratePoints(4).countOccupied
